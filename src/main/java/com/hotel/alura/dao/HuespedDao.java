...
public class HuespedDao {
    ...
    public DefaultTableModel listar(){
        em.getTransaction().begin();
        List<Huesped> listaHuespedes = em.createQuery("SELECT e FROM tbhuesped as e", Huesped.class).getResultList();
        ...
        String[] columnas = { "ID de Huesped", "Nombre", "Apellido", "Fecha de nacimiento", "Nacionalidad",
                "Telefono", "ID de Reserva" };
