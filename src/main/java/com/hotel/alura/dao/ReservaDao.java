...
public class ReservaDao {
    ...
    public DefaultTableModel listar(){
        em.getTransaction().begin();
        List<Reserva> listaReserva = em.createQuery("SELECT e FROM tbreservas as e",Reserva.class).getResultList();
        ...
        String [] columnas = {"ID de Reserva", "Fecha Check-In", "Fecha Check-Out", "Valor", "Forma de pago"};
    ...
    public DefaultTableModel buscarReservasPorApellidoHuesped(String apellido) {
        String jpql = "SELECT r FROM tbreservas r JOIN r.tbhuesped h WHERE h.apellido = :apellido";
    ...
    public DefaultTableModel buscarReservaPorId(Long id) {
        em.getTransaction().begin();
        List<Reserva> listaReserva = em.createQuery("SELECT r FROM tbreservas r WHERE r.id = :id", Reserva.class)
